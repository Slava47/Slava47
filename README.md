### Вячеслав Руденко
Python-разработчик из Воронежа. Создаю телеграм-ботов, приложения и инфраструктурные решения.

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&duration=3000&pause=500&color=58A6FF&width=435&lines=Python+Developer;Telegram+Bots+Creator;Flask+%26+Docker;Kubernetes+%26+ClickHouse;Open+to+collaboration)](https://git.io/typing-svg)
---
### Стек технологий
